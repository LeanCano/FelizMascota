...
export class UsuarioController {
  ...
  async create(
    ...
    //notificar al usuario cuidado con la direccion en anaconda
    let destino= usuario.correo;
    let asunto= "Registro a Mascota Feliz";
    let contenido=`Hola ${usuario.nombre}, su ususario es ${usuario.correo} y su contraseña es ${clave}`;
